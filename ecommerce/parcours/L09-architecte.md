...
>
> **Temps de travail typique :** 40 à 55 heures, dont quinze sur ton compte de résultat.
...
3. **Je calcule le volume que j'ai le droit de perdre** en coupant une remise, et je l'écris avant de couper.
...
|---|---|---|
| 1 | [**E12**](../modules/E12-marque-et-actif.md) § 1 à § 7 | Le test de coupure, la contradiction marque/performance, et la construction de capital de marque **en payant à la performance** — avec la preuve que le MER visé est hors d'atteinte par l'optimisation. |
...
| 4 | [**E14**](../modules/E14-plan-1M-semaine.md) § 6 | Le passage P5 → P5+ en cinq chantiers ([jalons](../mentorat/jalons.md)). Le dossier de l'épreuve en est une variante déformée : refais les cibles, ne les recopie pas. |
| 5 | [**C09 — Le Black Friday**](../etudes-de-cas/C09-piege-du-black-friday.md) | Une remise se juge sur la cohorte à douze mois. Le chantier le plus lourd de l'épreuve. |
...
| **Simulateur, une partie jusqu'à P5+**, puis `plan_objectif.py --ca-hebdo 1000000 --ebitda-cible 18` | Ton journal de décisions, et l'écart entre ton EBITDA final et 20,3 % | Tu identifies le mois de la décision qui a coûté le plus, et les mois écoulés avant qu'elle se voie |

> **Le travail qui compte le plus est le registre, pas le plan.** Le plan est borné : c'est de l'arithmétique. Le registre exige d'écrire une probabilité en face d'un événement qu'on préfère ne pas imaginer, puis de conclure par écrit qu'on ne fera rien contre certains. C'est le seul document du cursus qui demande de choisir ce qu'on accepte de subir.
...
**Exploitation** — panier moyen mixte 70,00 € TTC ; 61 903 commandes et 41 235 nouveaux clients par mois ; réachat 41 % du CA ; croissance sur 12 mois +2 % ; TVA 20 %. **Plan média** : Meta 62 %, TikTok 14 %, Google 18 %, influence et autres 6 %.
...
**Barème.** 4 le tableau (−0,5 par ligne fausse), 3 les MER, 1 la phrase. **0 à la question si le MER est calculé sur le CA HT** (éliminatoire, § 6).
...
*Un point de CA HT vaut `3 611 000 × 12 ÷ 100 = 433 320 €` par an.*
...
**Barème (5 pts par chantier).** 1 la cible, 1 les points, 1 les euros par an, 1 le mécanisme, 1 la durée. **−2 au chantier 2 si la baisse du nombre de commandes est appliquée au COGS** (les unités n'ont pas bougé). **−3 au chantier 5 si le mécanisme est « optimiser les campagnes ».**

### A3 — La somme, et pourquoi elle s'additionne

```
9,40 + 3,00 + 1,00 + 0,90 + 1,20 + 1,80 + 0,70 = 18,00 %
339 434 + 310 546 = 649 980 €/mois, soit 7 799 760 €/an contre 4 073 208 €
Écart : 3 726 552 € = 8,60 × 433 320 €
```
...
**Les deux exceptions.** **Si le chiffre d'affaires bouge** : logistique et COGS sont variables, les fixes ne le sont pas, la publicité est un budget — les points cessent d'être commensurables. **Si deux chantiers touchent le même levier physique** : le chantier 2 réduit la logistique par le nombre de colis, une renégociation tarifaire la réduirait par le prix ; ils se multiplient au lieu de s'ajouter.
...
|---:|---|---:|---:|---|
| **M1** | 5 — le MER | M9 | M18 | Le plus lent : ce qui met dix-huit mois se lance en premier |
...
| **M4** | 2 — le panier moyen | M5 | M10 | Précède le 1 : un panier plus élevé rend la coupe de remise supportable |
| **M10** | 1 — les remises | M11 | M18 | Dépend du 2 : couper avant d'avoir relevé le panier, c'est le faire payer au volume |
| **M12** | 6 — les frais fixes | M13 | M18 | **En dernier :** couper avant les cinq autres supprime les gens qui les mènent |
...
**Ce que le barème cherche : rien de significatif ne se produit avant le mois 10.** Qui juge ce plan au trimestre 2 le croira mort et coupera le chantier 5, le seul qui ne se rattrape pas. D'où la règle : **la trajectoire trimestrielle s'écrit et se signe au mois 1** — ce n'est pas une prévision, c'est une protection contre la décision qu'on prendra au mois 6. *Le plan consomme 640 000 € de trésorerie sur neuf mois contre 2 150 000 € disponibles.*

**Barème.** 4 l'ordre et ses deux critères, 3 la dépendance 2 → 1, 3 la trajectoire. **−3 si les frais fixes sont coupés au premier trimestre.**

### B1 — Le risque que chaque chantier crée

| Chantier | Le risque qu'il crée | Seuil d'alerte | Retour arrière |
|---|---|---|---|
| **1 — remises** | La frange qui n'achetait qu'en promotion s'en va | Commandes hebdo **−5,3 %** sur 3 semaines, hors saisonnalité | Remise ciblée sur les segments perdus, jamais publique |
...
| **3 — retours** | Le contact à J+10 **déclenche** des retours qui n'auraient pas eu lieu | Écart de retour entre groupe contacté et témoin **> 0,5 pt** sur 4 semaines | On arrête le contact, on garde le guide |
...
| **5 — MER** | Le chantier est coupé au premier trimestre difficile, avant d'avoir rien produit | Aucun seuil de performance avant M9 — c'est **la règle** | Seuil d'arrêt écrit au M1 : trafic de marque non progressé à M12 |
...
On retient 5,3 % et non 5,27 % : un seuil d'alerte s'arrondit dans le sens prudent.

**Barème.** 2 par chantier : 1 pour un risque réellement **créé par le chantier**, 1 pour un seuil chiffré et observable ; un risque générique vaut 0. La condition suspensive du chantier 4 sépare un plan d'un vœu.
...
`406 933 ÷ 433 320 = 0,94` — **ton registre vaut 0,94 point d'EBITDA par an, davantage que le chantier des frais fixes**, et personne ne le porte au budget.

| Risque | Espérance résiduelle | Gain de la mesure | Coût annuel | Verdict |
|---|---:|---:|---:|---|
| **R4** | 0 € | **119 596 €** | 6 000 € + 38 000 € une fois | **Retenue.** Payback : `38 000 ÷ 113 596 = 4,0 mois` |
| **R2** | 0,12 × 6 × 0,71 × 153 328 = **78 381 €** | **117 572 €** | 105 998 € | **Retenue de justesse** : +11 574 €/an |
| **R1** | 0,08 × 4 × 0,34 × 153 328 = **16 682 €** | 44 036 € | 55 000 € | **Non retenue à ce prix** : −10 964 €/an |
| **R3** | 0,05 × 1 × 1,00 × 153 328 = **7 666 €** | 23 000 € | 30 000 € | **Non retenue à ce prix** : −7 000 €/an |

Résultat inconfortable, d'où sa présence dans l'épreuve : **la mesure que tout le monde prend en premier — la redondance publicitaire — ne paie pas**, et celle que personne ne porte en comité rapporte vingt fois son entretien.

**Barème.** 4 les espérances et le classement, 4 les verdicts avec leur gain net (0,5 sans le gain net).
...
Reste après l'événement                                       =   517 057 €
Frais fixes mensuels                                          =   324 990 €
Autonomie restante                     517 057 ÷ 324 990      =   1,6 mois
```

Et c'est optimiste : le BFR de 2 480 000 € ne se dénoue pas pendant une rupture — le stock invendable ne redevient pas du cash. **R2 n'est pas un risque qui coûte 195 953 € par an ; c'est un risque qui, une fois sur huit, laisse MAVELLE avec sept semaines de trésorerie et un produit héros indisponible pendant huit de plus.**

**La règle :** *l'espérance décide des risques qui coûtent, jamais de ceux qui terminent ; pour ceux-là le critère est la survie du pire scénario.* R2 se traite donc quel que soit son prix. R1 et R3 restent non retenus : MAVELLE dégradée reste à l'équilibre, ses fixes ne pesant que 9,0 % du CA HT et sa publicité tombant avec son volume.

**Barème.** 2 désigner R2, 2 le calcul de trésorerie, 1 la règle. Désigner R1 vaut 0 : c'est le réflexe que la question attrape.
...
**La moitié de la création de valeur ne vient pas des euros gagnés, mais de la raison qu'on a de croire qu'ils reviendront.** Aucun chantier financier ne la fabrique : c'est le chantier 5 — le plus lent, et le premier qu'on coupe.

**Barème.** 3 les montants, 2 les pourcentages, 1 la vérification. Attribuer l'effet croisé à une des parts sans le dire vaut 3 sur 6.
...
2. **Une somme de chantiers hors de 17,9–18,1 %.** Un plan qui n'atteint pas sa cible n'est pas approximatif, il est faux.
...
5. **Un registre où les quatre mesures sont retenues.** Qui n'arbitre rien n'est pas un registre.

**Deux fautes lourdes :** appliquer la baisse du nombre de commandes au COGS (−2) ; désigner R1 en B3 (−5).

**En cas d'échec**, tu repasses sur un autre compte de résultat — une marque dont le MER est cette fois **sous** son seuil de résultat. La contrainte « sans croissance » y est intenable, et la première compétence évaluée est de le dire.

---

## 7. Les pièges de ce niveau

**1. Croire qu'un plan de marge est un exercice de coûts.** Deux des six chantiers — le panier moyen et le MER — se gagnent du côté du client et pèsent 2,80 des 8,60 points. Un directeur financier seul produit un plan à 5,80 points et le croit complet : le reste ne figure sur aucune ligne qu'il contrôle.

**2. Croire qu'un gain de COGS est un gain.** Le piège le plus cher du niveau : il se présente comme une victoire signée et datée — 1,20 point, 519 984 € par an, obtenus en une négociation. Le dossier de [L10](L10-expert-mondial.md) est cette décision prise sans panel aveugle, chez une marque qui a économisé 0,42 € par unité et perdu treize fois plus. **Une baisse de COGS par changement de spécification n'est pas un gain tant qu'aucun client n'a jugé le lot pilote.**

**3. Croire que la remise se supprime par décision, et qu'un plan de dix-huit mois se juge au bout de six.** La remise se supprime par substitution : le calendrier place le panier moyen **avant** elle, seule séquence où le client a une raison de rester ; inversée, la paire produit −5 % de volume et un plan à 15 %. Et la trajectoire est à 10,5 % au trimestre 2 — c'est là que quelqu'un demandera à quoi sert le chantier 5, qui porte 1,80 point et la moitié du multiple de sortie.

**4. Croire que le registre se remplit par prudence.** Il se remplit par calcul, et son résultat contredit les priorités que toute équipe se donne spontanément. Classer par espérance est facile ; écrire « non retenue » en face d'une ligne l'est moins, en sachant qu'il existe des risques où cette écriture est interdite.

**5. Croire que L09 mesure ton entreprise.** C'est le niveau où l'écart entre les deux échelles fait le plus de dégâts : la compétence L09 est celle qu'une marque **N4** croit posséder du seul fait d'être arrivée au volume. Or le volume ne démontre rien sur la marge — le modèle canonique fait 1 M€ par semaine à 10,1 % d'EBITDA, et le même chiffre d'affaires en produit 20,3 % ([canoniques § 8](../donnees/chiffres-canoniques.md)). Une marque N4 pilotée en L04 a bâti son organisation autour du premier chiffre, et découvrira en la vendant que la moitié de sa valeur n'a jamais été fabriquée.

---

*Fin du niveau L09. Suite : [L10 — Expert mondial](L10-expert-mondial.md) — trouver en trente minutes lequel des huit problèmes d'un dossier est le seul qui compte.*
